...
def main() -> None:
    ...
    search.add_argument("--chrome-cdp-endpoint", default=None, help="CDP endpoint of a running Chrome (default: $VALUEHIRE_PORTAL_CHROME_CDP_ENDPOINT or http://127.0.0.1:9222)")
    ...
    restart.add_argument("--chrome-cdp-endpoint", default=None, help="CDP endpoint of a running Chrome (default: $VALUEHIRE_PORTAL_CHROME_CDP_ENDPOINT or http://127.0.0.1:9222)")
    ...
    recovery.add_argument("--chrome-cdp-endpoint", default=None, help="CDP endpoint of a running Chrome (default: $VALUEHIRE_PORTAL_CHROME_CDP_ENDPOINT or http://127.0.0.1:9222)")
    ...
    snapshot.add_argument("--chrome-cdp-endpoint", default=None, help="CDP endpoint of a running Chrome (default: $VALUEHIRE_PORTAL_CHROME_CDP_ENDPOINT or http://127.0.0.1:9222)")
