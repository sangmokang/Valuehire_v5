...
Production code remains authoritative. This shared layer catches common operator
bypasses before they become a second gateway or an unsigned owner-agent enqueue.
"""
...
def check(tool, tool_input):
    ...
    if (
        os.environ.get("VALUEHIRE_DIRECT_GATEWAY_PROCESS") == "1"
